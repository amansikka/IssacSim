...
class featuresDetection:
    def __init__(self):
        ...
        self.LMIN = 20 #minimum length
        self.LR = 0 #real length of a line segment
        self.PR = 0 #the number of 

    #euclidian distance from point1
    ...
    def dist_point2line(self, params, line):
        A, B, C = params
    ...
    def seed_segment_growing(self, indices, break_point):
        ...
        while self.dist_point2line(line_eq, self.LASERPOINTS[PF][0]) < self.EPSILON:
            ...
            if self.dist_point2point(POINT, NEXTPOINT):
                break
            
        PF = PF - 1

        while self.dist_point2line():
            if PB < break_point:
                break
            else:
                m, b = self.odr_fit(self.LASERPOINTS[PB:PF])
        ...
        LR = self.dist_point2point(self.LASERPOINTS[PB][0], self.LASERPOINTS[PB][0])
